...
class UserTest < ActiveSupport::TestCase
  ...
  # Make sure the screen name is within length boundary.
  ...
  # Make sure the password is within length boundary.
  ...
  # Make sure the email can't be too long.
  ...
  def test_email_with_valid_examples
    ...
    valid_emails = valid_endings.collect do |ending|
      "foo.bar_1-0@baz-guux0.example.#{ending}"
    end
  ...
  # Test the screen name validator against valid screen names.
  ...
  # Test the screen name validator against invalid screen names.  
